...
function onAssetsLoaded() {
  ...
  var slotTextures = [
    PIXI.Texture.fromImage("assets/eggHead.png"),
    PIXI.Texture.fromImage("assets/flowerTop.png"),
    PIXI.Texture.fromImage("assets/helmlok.png"),
    PIXI.Texture.fromImage("assets/skully.png")
  ];
